...
#[AsAreabrick(id: 'cui-events')]
class Events extends AbstractCuiAreabrick implements EditableDialogBoxInterface
{
    ...
    {
        return 'Grid of event cards with date block, meta line and registration link.';
    }
