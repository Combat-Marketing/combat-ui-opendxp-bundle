...
#[AsAreabrick(id: 'cui-feature-grid')]
class FeatureGrid extends AbstractCuiAreabrick implements EditableDialogBoxInterface
{
    ...
    {
        return 'Grid of feature cards with icon, title and copy.';
    }
